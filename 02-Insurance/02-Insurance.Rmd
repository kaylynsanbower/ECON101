...
---
# Risk aversion
```{tikz echo=FALSE, fig.ext='png', cache=TRUE, tikz-aversion, fig.cap="Risk Aversion", fig.width=3}
\usetikzlibrary{calc}
...
---
# Risk Premium
```{tikz echo=FALSE, fig.ext='png', cache=TRUE, tikz-premium, fig.cap="Risk Premium"}
\usetikzlibrary{calc}
\begin{tikzpicture}[my plot/.style={
                        thick,
                        smooth,
...
```{tikz echo=FALSE, fig.ext='png', cache=TRUE, tikz-selection, fig.cap="Adverse Selection"}
\usetikzlibrary{calc}
\usetikzlibrary{arrows}
\begin{tikzpicture}
\draw[thick,->] (0,0) -- (0,6) node[anchor=north west] {$p$};
\draw[thick,->] (0,0) -- (8,0) node[anchor=south east] {$q$};
\draw (0,5) -- (6,1) node[anchor=north] {Demand};
\draw (0,3) -- (6,2) node[anchor=north] {AC};
\draw (0,3) -- (6,0.5) node[anchor=south] {MC};
\draw (0,6) -- (6,6) node[anchor=north] {$\bar{q}$};
\end{tikzpicture}
```
