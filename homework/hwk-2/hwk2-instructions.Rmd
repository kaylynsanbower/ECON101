...
3. Sloan and Hsieh, Chapter 5, Question 5.3: The supplier-induced demand model has been proposed as a framework for explaining important features of physicians' services markets. Please answer (in short answers of 2-3 sentences at most) the following questions about supplier-induced demand:<br><br>
    + What is meant by supplier-induced demand?<br>
    
    + What empirical evidence has been used to support the supplier-induced demand hypothesis?<br>
    
    + If we assume that supplier-induced demand exists, what would we expect to happen to quality of care if we move from a fee-for-service reimbursement model to a fully capitated reimbursement model?<br>
