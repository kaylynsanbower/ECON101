...
.pull-left[
  ![:scale 450px](pics/dartmouth_map.png)
]

.pull-right[
  ![:scale 450px](pics/dartmouth_dist.png)
]
...
---
# Wasteful?
- Estimates are that more than 30% of health care expenditures are "wasteful": [The Atlantic, 2013 Article](https://www.theatlantic.com/health/archive/2013/12/youre-getting-too-much-healthcare/281896/)
...
---
# Example
Assume $B(x)=8x^{1/2}$ and $NB^{0}=2$:<br>
...
An increase in the administratively set price leads to a \textit{decrease} in quantity of services provided. And vice versa, a reduction in price leads to an \textit{increase} in quantity provided. Why?
...
.center[
$\frac{B_{x} - p_{d}}{NB} \frac{R + (p_{s} - c)x}{p_{s}-c} = - \frac{1}{\varepsilon_{n,NB}}$
]<br>
